CONTAINER Tshotblocks
{
    ...
    GROUP ID_TAGPROPERTIES
    {
        ...
        GROUP SHOTBLOCKS_GRP_LOOK_AT
        {
            ...
            // Aim Lock: how much the aim resists Angular damping (0% = aim
            // lags with the body, 100% = aim stays locked on target even
            // at 100% Angular). Shared with Chase, which reads the same ID.
